...
# In scenario (alias of it), write the processing of the test for each item you want to check.
 scenario "Test task list" do
   Task.create!(name: 'test_task_1', content: 'testtesttest',status: 'started',priority: 'medium', start_date: '10.2.2019', end_date: '20.10.2019')
   Task.create!(name: 'test_task_2', content: 'samplesample',status: 'completed',priority: 'high', start_date: '10.2.2019', end_date: '20.10.2019')
   visit tasks_path
   save_and_open_page
 ...
 scenario "Test task details" do
   @task = Task.create!(name: 'test_task_01', content: 'testtesttest',status: 'started',priority: 'medium', start_date: '10.2.2019', end_date: '20.10.2019')
   visit task_path(id: @task.id)
   expect(page).to have_content('test_task_01')
   expect(page).to have_content('testtesttest')
 end
 scenario "Test whether tasks are arranged in descending order of creation date" do
   Task.create!(name: 'test_task_01', content: 'testtesttest',status: 'started',priority: 'medium', start_date: '10.2.2019', end_date: '20.10.2019')
   Task.create!(name: 'test_task_02', content: 'samplesample',status: 'completed',priority: 'high', start_date: '10.2.2019', end_date: '20.10.2019')
   @task = Task.order('created_at ASC')
 end
 scenario "Test task updating" do
   task1=Task.create!(name: 'test_task_01', content: 'testtesttest', status: 'started',priority: 'medium', start_date: '10.2.2019', end_date: '20.10.2019')
